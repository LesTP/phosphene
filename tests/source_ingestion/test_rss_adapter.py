...
def test_rss_adapter_normalizes_feed_entries_and_advances_marker(
    ...
    monkeypatch.setattr("phosphene.source_ingestion.rss.urlopen", fake_urlopen)
...
def test_atom_adapter_normalizes_namespaced_entries(
    ...
    monkeypatch.setattr(
        "phosphene.source_ingestion.rss.urlopen",
...
def test_disabled_rss_adapter_is_not_polled(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("phosphene.source_ingestion.rss.urlopen", fail_if_called)
