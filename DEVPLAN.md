...
- **Focus** — Phase 3 ready for phase planning
- **Blocked/Broken** — None
...
- **Phase 3 (next)** — Embedding search and graph operations: `search_by_embedding`, `add_links`, `get_linked`, `get_personality_context`.
