...
| 4 | Gateway | Message bus for input and output. Needed before user-visible output. | Phase 2 in progress |
...
See DECISIONS.md for the full decision log (D-1 through D-37).
